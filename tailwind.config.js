  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        slideIn: "slideIn ease-out 1s 1s forwards ",
        fadeIn01s: "fadeIn ease-in 0.1s forwards",
        fadeIn1s: "fadeIn ease-in 1s 1s forwards",
        fadeIn2s: "fadeIn ease-in 1s 2s forwards",
        ...
        blobAround1:
          "fadeIn ease-in 1s 2s forwards, bloberize1 ease-in-out 90s infinite",
        blobAround2:
          "slideIn2 ease-out 1s 2s forwards,  bloberize2 ease-in-out 30s infinite",
        blobAround3:
